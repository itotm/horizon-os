...
./ctx/download-github.sh https://github.com/itotm/eleven-twilight/releases/download/v2.3/ElevenTwilight-2.3.tar.gz /usr/share/icons
sleep 1
...
sleep 1
./ctx/download-github.sh https://github.com/itotm/plasma-wallpaper-potd-enhanced/releases/download/v1.5.5/com.plasma.wallpaper.potd-enhanced-1.5.5.tar.gz /usr/share/plasma/wallpapers
sleep 1
