...
sleep 1
./ctx/download-github.sh https://github.com/itotm/plasma-wallpaper-potd-enhanced/releases/download/v1.5.1/com.plasma.wallpaper.potd-enhanced-1.5.1.tar.gz /usr/share/plasma/wallpapers
sleep 1
